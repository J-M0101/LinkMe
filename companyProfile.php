            ...
            */
            ...
            <div style="text-align: left; font-size: 16px; font-family: Arial;">
              ...
              <div class="mt4 mb2" style="font-size: 20px";>
                ...
                Facebook: <?php echo $row["username"];?>
              </div>
              <!-- Facebook Info -->
              <div class>
        ...
        <div class="flex h-60 mt4 justify-center">
          <div class="flex w-90 yellowbackground">
            ...
            */
            ...
            $twitter_ratio = $row["twitter_follower_count"] / $total_count;
            $facebook_ratio = $row["facebook_follower_count"] / $total_count;
            ...
            <div class="pa3 w-60">
              <table class="charts-css column show-heading show-labels show-primary-axis show-4-secondary-axes show-data-axes data-spacing-15 hide-data">
                ...
                <tbody>
                  <tr>
                    <th> Youtube </th>
                    <td style="--size:<?php echo $youtube_ratio;?>"></td>
                  </tr>
                  <tr>
                    <th> Twitter </th>
                    <td style="--size:<?php echo $twitter_ratio;?>"></td>
                  </tr>
                  <tr>
                    <th> Facebook </th>
                    <td style="--size:<?php echo $facebook_ratio;?>"></td>
                  </tr>
                </tbody>
              </table>
            </div>
